        ...
        <div class="main-content">
          ...
          <el-row>
            <el-col :span="24" class="" >
                ...
                <el-select v-model="loginParams.business_type" placeholder="请选择类型" @change="getChange">
                  <el-option
            ...
            <el-col :span="24" class="" >
                ...
                <el-input
                  ...
                  @input="onlyNum(loginParams.house_num,'house_num')"
                  placeholder="请输入房号"
                ></el-input>
            ...
            <el-col :span="24" class="" >
                ...
                <el-input
                  ...
                  @input="onlyNum(loginParams.floor,'floor')"
                  placeholder="请输入楼层"
                ></el-input>
            ...
            <el-col :span="24" class="" >
                ...
                <el-input
                  ...
                  @input="onlyNum(loginParams.advance_day,'advance_day')"
                  placeholder="请输入"
                ></el-input>
